    ...
    return (
        <div className='max-w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 items-center mt-10'>
            <div className='space-y-4 lg:space-y-6 order-2 lg:order-1'>
                ...
                <div className='text-5xl space-y-3'>
                    <h2 className='font-bold text-red-600'>One Subscription.</h2>
                    <h2 className='font-bold bg-gradient-to-r from-orange-600 to-orange-300 bg-clip-text text-transparent'>All the AIs You Need</h2>
                </div>
                ...
                <button className='flex items-center btn font-semibold bg-red-600 py-7 shadow-lg shadow-red-500/50 rounded-2xl px-5 text-base text-white'>Get Unlimited Access <span className='text-xl'><FaLongArrowAltRight /></span></button>
